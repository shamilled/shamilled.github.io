...
function checkQues14b() {
    var x = document.getElementById("ques14b").value;
    
	if ((x.toLowerCase() == "true")||(x.toLowerCase() == "t")) {
		num = num + 200;
		//alert(num);
		document.getElementById('used14').style.display="block";
		document.getElementById('correct').style.display="block";
		document.getElementById('q14bdiv').style.display="none";
		document.getElementById('show14').style.display="none";		
		document.getElementById('scoreBox').innerHTML = "$" + num;
		document.getElementById('par14').style.display="none"
		return false;
...
function show14(){
	...
	if (y <= 5){
		...
		/*alert("y is greater than 5")*/
		document.getElementById('q14bdiv').style.display="block";
		return false;
	}
}
...
function checkQues31b() {
    var x = document.getElementById("ques31b").value;
    
	if ((x.toLowerCase() == "cancellous")||(x.toLowerCase() == "cancellous tissue")) {
		num = num + 600;
		//alert(num);
		document.getElementById('used31').style.display="block";
		document.getElementById('correct').style.display="block";
		document.getElementById('q31bdiv').style.display="none";
		document.getElementById('show31').style.display="none";	
		document.getElementById('scoreBox').innerHTML = "$" + num;
		document.getElementById('par31').style.display="none"
		return false;		
...
function checkQues32() {
	...
	if ((x.toLowerCase() == "ribosomes")||(x.toLowerCase() == "ribosome")) {
		...
		document.getElementById('par32b').style.display="none";
		return false;
		}
	else{
	//alert("Wrong name");
...
function checkQues32b() {
    var x = document.getElementById("ques32b").value;
	...
	if ((x.toLowerCase() == "rough endoplasmic reticulum")||(x.toLowerCase() == "rough er")) {
		...
		document.getElementById('used32').style.display="block";
		document.getElementById('correct').style.display="block";
		document.getElementById('q32bdiv').style.display="none";
		document.getElementById('show32').style.display="none";		
		document.getElementById('scoreBox').innerHTML = "$" + num;
		document.getElementById('par32').style.display="none";
		document.getElementById('par32b').style.display="none";
...
function checkQues33b() {
    var x = document.getElementById("ques33b").value;
	...
	if ((x.toLowerCase() == "false")||(x.toLowerCase() == "f")) {
		...
		document.getElementById('used33').style.display="block";
		document.getElementById('correct').style.display="block";
		document.getElementById('q33bdiv').style.display="none";
		document.getElementById('show33').style.display="none";		
		document.getElementById('scoreBox').innerHTML = "$" + num;
		document.getElementById('par33').style.display="none"
		return false;
...
function show31(){
	...
	if (y <= 5){
		...
		/*alert("y is greater than 5")*/
		document.getElementById('q31bdiv').style.display="block";
		return false;
	}
}
...
function show32(){
	...
	if (y <= 5){
		...
		/*alert("y is greater than 5")*/
		document.getElementById('q32bdiv').style.display="block";
		return false;
	}
}
...
function show33(){
	...
	if (y <= 5){
		...
		/*alert("y is greater than 5")*/
		document.getElementById('q33bdiv').style.display="block";
		return false;
	}
}
...
function checkQues54() {
	...
	if ((x.toLowerCase() == "glands")||(x.toLowerCase() == "gland")) {
		...
		document.getElementById('par54b').style.display="none";
		return false;
		}
	else{
	//alert("Wrong name");
...
function checkQues54b() {
    var x = document.getElementById("ques54b").value;
    
	if (x.toLowerCase() == "skeletal") {
		num = num + 1000;
		//alert(num);
		document.getElementById('used54').style.display="block";
		document.getElementById('correct').style.display="block";
		document.getElementById('q54bdiv').style.display="none";
		document.getElementById('show54').style.display="none";	
		document.getElementById('scoreBox').innerHTML = "$" + num;
		document.getElementById('par54').style.display="none";
		document.getElementById('par54b').style.display="none";
	...
	document.getElementById('scoreBox').innerHTML = "$" + num;
	document.getElementById('par54').style.display="none";
	document.getElementById('par54b').style.display="block";
	return false;
	}
...
function show54(){
	...
	if (y <= 5){
		...
		/*alert("y is greater than 5")*/
		document.getElementById('q54bdiv').style.display="block";
		return false;
	}
}
